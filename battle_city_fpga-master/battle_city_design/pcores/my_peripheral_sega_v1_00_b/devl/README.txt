...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\materija\ra115\projekat_radi_3\projekat_radi\battle_city_fpga-master\battle_city_design
  logical library name                       : my_peripheral_sega_v1_00_b
  top name                                   : my_peripheral_sega
  version                                    : 1.00.b
  type                                       : AXI4LITE slave
...
- HDL source file(s)
  ...
  hdl/vhdl/my_peripheral_sega.vhd
...
- XPS interface file(s)
  ...
  data/my_peripheral_sega_v2_1_0.mpd
  ...
  data/my_peripheral_sega_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/my_peripheral_sega.xise
...
- XST synthesis file(s)
  ...
  devl/synthesis/my_peripheral_sega_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/my_peripheral_sega_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/my_peripheral_sega_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	C:\materija\ra115\projekat_radi_3\projekat_radi\battle_city_fpga-master\battle_city_design\C:\Xilinx\14.6\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_lite_ipif_v1_01_a\doc\axi_lite_ipif_ds765.pdf
