...
-- Date:              Wed May 11 19:02:20 2016 (by Create and Import Peripheral Wizard)
...
architecture IMP of user_logic is
  ...
  signal joy_s : std_logic_vector(23 downto 0);	
  component sega_joystic_driver is
  ...
  end component sega_joystic_driver;

begin

	 
  sega_driver : sega_joystic_driver
    port map(
			  data_i => data_i,
			  mux_o => mux_o,
			  sel_o => sel_o,
  ...
  SLAVE_REG_READ_PROC : process( slv_reg_read_sel, joy_s, slv_reg0, slv_reg1, slv_reg2, slv_reg3, slv_reg4, slv_reg5, slv_reg6, slv_reg7, slv_reg8, slv_reg9, slv_reg10, slv_reg11, slv_reg12, slv_reg13, slv_reg14, slv_reg15, slv_reg16, slv_reg17, slv_reg18, slv_reg19, slv_reg20, slv_reg21, slv_reg22, slv_reg23, slv_reg24, slv_reg25, slv_reg26, slv_reg27, slv_reg28, slv_reg29, slv_reg30, slv_reg31 ) is
  begin

    case slv_reg_read_sel is
      when "10000000000000000000000000000000" => slv_ip2bus_data <= "00000000"&joy_s ;
